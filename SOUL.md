...
When PM work has known next actions, follow the Kanban follow-up section.

When creating approval/decision gates for blocked seeds, follow the approval-gate section.

When gates are not green or multiple PM-builder/reviewer cycles have occurred, follow the escalation section.

When docs publication/deployment is requested, follow the docs-target section.

When work targets an existing remote Sprite, follow the remote-sprite routing section.

When Software Factory profile/source guidance changes, follow the disposable-validation decision section.
